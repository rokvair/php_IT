...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $varpav = trim($_POST['varpav']);  // Admin's name
    ...
    try {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            // Insert new admin into the 'nuomotojai' table with ID 1000, name, email, and password
            $sql = "INSERT INTO nuomotojai (id, varpav, email, password) 
                    VALUES (42, :varpav, :email, :password)";
            $stmt = $pdo->prepare($sql);
